...
=======
   2. กดปุ่มเลือกระดับ ดูตามประเภทที่เลือก
>>>>>>> 1583c2c4ecedb6b09f09301ccbf147c62594b787
5. ระบบจะแสดงรายงานตามช่วงเวลาและ skill ที่เลือก โดยแสดงคะแนนและรายละเอียดของการสอบในแต่ละครั้ง
6. ระบบจะแสดง ranking ของคุณตาม skill และ level ที่เลือก โดยแสดงอันดับของคุณในกลุ่มผู้สอบทั้งหมดที่มี skill และ level เดียวกัน
7. ระบบจะแสดงประวัติการสอบทุกครั้งใน skill และ level ที่เลือก โดยแสดงวันที่สอบ คะแนน และรายละเอียดของการสอบในแต่ละครั้ง